...
public class MiningData {
    ...
    private static final List<Task> PREMADE_TASKS = List.of(
            new Task("Skilling", "Mining", "", "Copper Ore", 1),
            new Task("Skilling", "Mining", "", "Iron Ore", 15),
            new Task("Skilling", "Mining", "", "Gold Ore", 20),
            new Task("Skilling", "Mining", "", "Coal Ore", 200),
            new Task("Skilling", "Mining", "", "Adamantite Ore", 30),
            new Task("Skilling", "Mining", "", "Runite Ore", 40),
            new Task("Skilling", "Mining", "", "Dragon Ore", 60),
            new Task("Skilling", "Mining", "", "Rune Essence", 200),
            new Task("Bosses", "Barrows", "", "Oxi Ore", 200),
            new Task("Bosses", "Barrows", "", "Luminite Ore", 200));
